...
def _process_synth_text(sample: dict[str, Any]) -> str:
    """Process synthetic dataset sample text."""
    return f"<|im_start|>user\n{sample['query']}<|im_end|>\n<|im_start|>assistant\n<think>\n{sample['synthetic_reasoning']}\n</think>\n{sample['synthetic_answer']}<|im_end|>"


# Add your dataset here - more information at docs/datasets.md
DATASETS = {
    # custom datasets definition
    "synth": DatasetConfig(
        path="./data/huggingface/synth",
        loader=lambda path: load_dataset(path, split="train", streaming=True)
        .select_columns(["query", "synthetic_reasoning", "synthetic_answer"])
        .skip(1000),
        sample_processor=_process_synth_text,
    ),
